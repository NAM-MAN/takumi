...
4. **Opus 4.8 既定**: `claude --model opus` 推奨 (2026-06-25、Fable が preview 化 + Opus 2× 価格になり default から外した。Fable は opt-in、再昇格条件は `skills/takumi/dispatch/routing-mode.md`)。effort = xhigh、`max` は真に難しい問題のみ、subagent は並列 fan-out の時だけ spawn
...
| [`opus-4-8.md`](docs/CONTRIBUTING/opus-4-8.md) | effort / subagent / adaptive thinking |
