...
詳細 recipe は **`compression.md`**、Phase 実装は **`../verify-loop/runtime.md`** の 3 Phase 構成を参照。
...
| file | 用途 |
|---|---|
| `../strict-refactoring/rules-heuristics.md` (§14 テスト命名) | 命名規約の起源。本ドキュメントはこれを verify 側に継承 |
