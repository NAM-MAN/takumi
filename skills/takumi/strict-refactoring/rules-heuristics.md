...
本 skill (`SKILL.md`) から参照される Level 2 の推奨ヒューリスティック (14 個、4 カテゴリ)。strictness が L1+L2 以上で適用される。必須不変条件 (L1) は `rules-required.md`、UI state は `rules-ui-state.md`。

---

## Default Heuristics (L2、14 個、4 カテゴリ)
