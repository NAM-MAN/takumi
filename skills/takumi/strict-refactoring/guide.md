...
- `L1+L2`: + default heuristics 14 個 (`rules-heuristics.md` 参照)
...
## Standard Heuristics (L2、14 個、4 カテゴリ)

<details>
<summary><b>4 カテゴリ 14 ルール (クリックで展開)</b></summary>
...
| `rules-heuristics.md` (同ディレクトリ) | L2 default heuristics 14 個の詳細 |
