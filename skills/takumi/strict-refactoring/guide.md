...
- `L1+L2`: + default heuristics 12 個 (`rules-heuristics.md` 参照)
...
## Standard Heuristics (L2、12 個、4 カテゴリ)

<details>
<summary><b>4 カテゴリ 12 ルール (クリックで展開)</b></summary>
...
| `rules-heuristics.md` (同ディレクトリ) | L2 default heuristics 12 個の詳細 |
